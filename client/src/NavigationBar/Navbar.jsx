...
export default function Navbar() {
  ...
  <div className="sm:hidden" id="mobile-menu">
    <div className="space-y-1 px-2 pb-3 pt-2">
      <a className="bg-gray-900 text-white block rounded-md px-5 py-2 text-xl font-medium" aria-current="page">Home</a>
      <a className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-5 py-2 text-xl font-medium">Team Builder</a>
      <a className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-5 py-2 text-xl font-medium">Players</a>
      <a className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-5 py-2 text-xl font-medium">Predictions</a>
    </div>
  </div>
</nav>
  )
